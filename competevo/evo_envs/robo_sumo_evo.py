...
class RoboSumoEvoEnv(MultiEvoAgentEnv):
    WIN_REWARD = 2000.
    DRAW_PENALTY = -1000.
    ...
    def __init__(self, max_episode_steps=500, min_radius=None, max_radius=None, **kwargs):
        super(RoboSumoEvoEnv, self).__init__(**kwargs)
    ...
    def _step(self, actions):
        ...
        for i, agent in self.agents.items():
            ...
            if (self_xyz[2] < 0.29 + self.arena_height or self_xyz[2] > 1.1 + self.arena_height or 
            ...
            for j, opp in self.agents.items():
                ...
                if (opp_xyz[2] < 0.29 + self.arena_height or opp_xyz[2] > 1.1 + self.arena_height or 
